            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              ...
              <div className="lg:w-48 space-y-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full py-3 bg-[#a7ff59] text-black rounded-xl hover:bg-[#8fee3f] transition-colors racing font-bold"
                >
                  <i className="bx bx-download mr-2"></i>
                  Download PDF
                </motion.button>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            >
              <div className="w-10 h-10 bg-[#a7ff59] rounded-lg flex items-center justify-center mr-4">
