      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-end">
              <button className="w-full py-3 bg-[#a7ff59] text-black rounded-xl hover:bg-[#8fee3f] transition-colors racing font-bold">
                Apply Filters
              </button>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <select className="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#a7ff59] focus:border-transparent openSans text-sm">
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-4 bg-white border-2 border-[#a7ff59] text-[#a7ff59] rounded-xl hover:bg-[#a7ff59] hover:text-black transition-all duration-300 racing font-bold">
